  ...
  return (
    <PlusSt>
      <div>
        {
          props.type === 'words' && (
            <svg onClick={() => props.toGeneralPage()} width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        (props.type === 'lists' || props.type === 'notes' || props.isOwner) && (
          <svg onClick={() => props.openModal()} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
