...
const Header:React.FC<HeaderType> = ({togglerMenu, currentListName, currentPage}) => {
  ...
  return (
    <HeaderSt>
      <div className="wrapper">
        <svg onClick={() => togglerMenu()} className='menu' width="21" height="24" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
