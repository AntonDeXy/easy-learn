  ...
  return (
    <FooterSt>
      <div className="wrapper">
        <Link to='/lists' onClick={() => setCurrentPage('lists')}>
          <svg color={'#F9B299'} className={currentPage === 'lists' ? 'activeTab' : ''} width="24" height="20" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link to='/notes' >
          <svg color={'#F9B299'} className={currentPage === 'notes' ? 'activeTab' : ''} width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link to='/help' >
          <svg color={'#F9B299'} className={currentPage === 'help' ? 'activeTab' : ''} width="17" height="24" viewBox="0 0 17 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg color={'#F9B299'} className={currentPage === 'words' ? 'activeTab' : ''} onClick={() => StartTest()} width="21" height="24" viewBox="0 0 21 24" xmlns="http://www.w3.org/2000/svg">
