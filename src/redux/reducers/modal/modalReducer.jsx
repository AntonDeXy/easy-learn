...
export const setItemsForTest = (variantsCount) => ({type: 'SET_ITEMS_FOR_TEST', data: {variantsCount: variantsCount ? variantsCount : 3}})
...
export const setTestModal = (modalData, variantsCount) => async (dispatch) => {
  ...
  await dispatch(setItemsForTest(variantsCount))
}
