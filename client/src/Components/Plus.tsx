...
const Plus:React.FC<PlusType> = ({type, isOwner, toGeneralPage, openModal}) => {
  return (
    <PlusSt>
      <div>
        {
          type === 'words' && (
            <Link className='back-arrow' to='/lists'>
              <svg onClick={() => toGeneralPage && toGeneralPage()} width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        (type === 'lists' || type === 'notes' || isOwner) && (
          <svg onClick={() => openModal()} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
